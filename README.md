...
> Data source: [Add the Kaggle/source link you downloaded this from]

## Analysis Covered

1. **Batting Analysis** — batting average & strike rate, most fours/sixes, powerplay vs. death-over strike rate, 50s/100s count, boundary percentage
2. **Bowling Analysis** — economy rate, best bowling figures, batter-vs-bowler head-to-head, dot-ball percentage, powerplay vs. death-over wicket-takers
3. **Team-Level Analysis** — win percentage, toss impact on match outcome, season-wise team performance, highest totals & win margins, head-to-head records
4. **Match-Context Analysis** — most frequent Player of the Match winners, super over matches, venue scoring patterns, season-wise scoring trends
5. **Cross-Dataset Analysis** — merged views combining ball-by-ball data with match context (season, venue, toss/result)
6. **Visualizations** — season-wise run trends, over-by-over scoring heatmap, team win % chart, toss-decision vs. outcome chart
...
Pratik Jadhav—http://www.linkedin.com/in/pratikjadhav99
